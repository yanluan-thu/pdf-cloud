...
! qinyi
  subroutine compute_uwshcu_inv( mix      , mkx        , iend          , ncnst     , dt       ,  & 
                                 ...
                                 qtu_inv  , thlu_inv ) ! qinyi 2017-04-22 17:54:32
...
! qinyi
    real(r8), intent(out)   :: qtu_inv(mix,mkx+1)
    !2017-04-22 17:54:48
    real(r8), intent(out)   :: thlu_inv(mix,mkx+1)
...
! qinyi
    real(r8)                :: qtu(mix,0:mkx)
    ! 2017-04-22 17:55:26
    real(r8)                :: thlu(mix,0:mkx)
...
! qinyi
  subroutine compute_uwshcu( mix      , mkx       , iend         , ncnst    , dt        , &
                             ...
                             qtu_out  , thlu_out) ! qinyi 2017-04-22 17:57:07
...
! qinyi
    real(r8), intent(out)   :: qtu_out(mix,0:mkx)
    ! 2017-04-22 17:57:40
    real(r8), intent(out)   :: thlu_out(mix,0:mkx)
