...
! qinyi
  integer :: qtu_idx, umf_idx, thlu_idx
...
! qinyi
  call pbuf_add_field('qtu_shal','global',dtype_r8,(/pcols,pverp/),qtu_idx)
  call pbuf_add_field('thlu_shal','global',dtype_r8,(/pcols,pverp/),thlu_idx)
  call pbuf_add_field('umf_shal','global',dtype_r8,(/pcols,pverp/),umf_idx)
  call pbuf_add_field('CLDTOP',  'global' ,dtype_r8,(/pcols,1/),   cldtop_idx )
  call pbuf_add_field('CLDBOT',  'global' ,dtype_r8,(/pcols,1/),   cldbot_idx )
